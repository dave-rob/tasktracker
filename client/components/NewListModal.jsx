    ...
    <div className="relative p-4 w-full max-w-md max-h-full">
        ...
        <div className="relative bg-white rounded-lg shadow dark:bg-gray-700 p-4">
            ...
            <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button onClick={createNewList} className="text-slate-900 inline-flex items-center bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:outline-none focus:ring-slate-900 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
